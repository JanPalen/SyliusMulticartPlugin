...
{
    public function findCarts(ChannelInterface $channel, ?CustomerInterface $customer, ?string $machineId): array;
    ...
    public function countCarts(ChannelInterface $channel, ?CustomerInterface $customer, ?string $machineId): int;
